...
RUTA_LOGS = "../logs_anonimizados_optimizados/"
ARCHIVO_SALIDA = "../Resultados/datos_pipeline_real_optimizado.txt"
...
def guardar_diccionario_salida(tiempos_promedio: dict, archivo_salida: str, archivos_procesados: int) -> None:
    """
    Guarda en disco el diccionario de tiempos medio del Escenario Real Optimizado con
...
def main() -> None:
    ...
    """
    print("Inicio del preprocesado de logs para la construcción del Escenario Real Optimizado.")
